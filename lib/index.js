...
var DiffViewer = /** @class */ (function (_super) {
    ...
    function DiffViewer(props) {
        ...
        _this.renderDiff = function () {
            var _a = _this.props, oldValue = _a.oldValue, newValue = _a.newValue, noise = _a.noise, splitView = _a.splitView, disableWordDiff = _a.disableWordDiff, compareMethod = _a.compareMethod, linesOffset = _a.linesOffset;
            var _b = compute_lines_1.computeLineInformation(oldValue, newValue, noise, disableWordDiff, compareMethod, linesOffset), lineInformation = _b.lineInformation, diffLines = _b.diffLines;
