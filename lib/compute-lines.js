                        ...
                        if (typeof valueActualObj === typeof valueExpectedObj) {
                            if (typeof valueExpectedObj === "object" && Array.isArray(valueExpectedObj)) {
                                ...
                                if (output_1.length === 1) {
                                    ...
                                    result.push({ count: -1, removed: output_1[0].removed, value: key + ": " + output_1[0].value });
                                    result.push({ count: -1, added: output_1[1].added, value: key + ": " + output_1[1].value });
                                }
                                // output.map((res) => {
                                // 	result.push(res)
                                // })
