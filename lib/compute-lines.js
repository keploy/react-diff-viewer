                        ...
                        if (el != undefined) {
                            ...
                            if (dotIndx === -1) {
                                ...
                                if (typeof oldVal === "object" && oldVal != null && key_1 in oldVal) {
                                    ...
                                    console.log("line 79", repOld, JSON.parse(JSON.stringify(repOld[0])), oldVal[key_1]);
...
var computeLineInformation = function (oldString, newString, noise, disableWordDiff, compareMethod, linesOffset) {
    ...
    var diffArray = diff.diffLines(addNoiseTags(oldString, "keploy.noise.l", noiseTmp, false)[0], addNoiseTags(newString, "keploy.noise.r", noise, false)[0], {
        newlineIsToken: true,
