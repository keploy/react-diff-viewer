...
function formatStr(str) {
    var replaceCurlOpen = str.replace("{", "{\n");
    var replaceCurlClose = replaceCurlOpen.replace("}", "\n}");
    var replaceSqBrackOpen = replaceCurlClose.replace("[", "[\n");
    var replaceSqBrackClose = replaceSqBrackOpen.replace("]", "\n]");
    var replaceComma = replaceSqBrackClose.replace(",", ",\n");
    return replaceComma;
    // let i = 0;
