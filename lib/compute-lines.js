...
function noiseDiffArray(count, expectedObj, actualObj) {
    var result = [];
    var expectedLines = constructLines(JSON.stringify(expectedObj, null, 2)), actualLines = constructLines(JSON.stringify(actualObj, null, 2));
...
function CompareJSON(expected, actual, noise, flattenKeyPath) {
    ...
    switch (typeof expectedValue) {
        ...
        case "object": {
            ...
            if (noise.includes(flattenKeyPath)) {
                var output = noiseDiffArray(-2, expectedValue, actualValue);
