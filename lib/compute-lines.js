...
var computeLineInformation = function (oldString, newString, noise, disableWordDiff, compareMethod, linesOffset) {
    ...
    var expected = JSON.stringify(addNoiseTags(oldString, "keploy.noise.l", noiseTmp, false)[0]);
    var actual = JSON.stringify(addNoiseTags(newString, "keploy.noise.r", noise, false)[0]);
